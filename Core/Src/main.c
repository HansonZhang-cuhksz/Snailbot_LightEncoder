...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED2_CTRL_Pin|LED1_CTRL_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LED2_CTRL_Pin LED1_CTRL_Pin */
  GPIO_InitStruct.Pin = LED2_CTRL_Pin|LED1_CTRL_Pin;
